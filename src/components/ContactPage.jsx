...
export default function ContactPage() {
  ...
  return (
    <div className="relative min-h-screen bg-black text-white flex flex-col items-center justify-center px-6 py-20 overflow-hidden">
      ...
      >
        Always open to conversations — whether it’s design, frontend architecture,
        or just a chat about creativity and tech ☕

        Feel free to reach out via email, phone, or connect on social media! I would love to hear from you.
